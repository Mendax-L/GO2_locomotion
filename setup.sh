...
export CUDA_VISIBLE_DEVICES=0,3;python scripts/rsl_rl/train.py --task=Isaac-Velocity-Flat-Unitree-Go2-v0 --num_env 4096 --headless --experiment_name flat_vels_test_1 --max_iterations 10000 --video
